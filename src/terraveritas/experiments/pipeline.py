...
def evaluate_repair(
    *,
    ...
    bucket_address: str = "aws_s3_bucket.data",
    ...
    before_invariant = evaluate_s3_public_access_exposure(before_plan, bucket_address)
    after_invariant = evaluate_s3_public_access_exposure(after_plan, bucket_address)
    ...
    scanner_baseline = compute_scanner_only_baseline(
        rule_id=rule_id, after_scan=after_scan, differential=differential
    )
